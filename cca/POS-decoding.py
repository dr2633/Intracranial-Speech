...
stim = 'Jobs2'
run = 'run-01'
classes = ['NOUN', 'VERB', 'ADJ', 'DET']  # Classes for POS decoding
...
fig_path = os.path.join(base_path, 'figures', 'POS-decoding')
...
def run_analysis(analysis_type):
    ...
    # Create epochs
    epochs = mne.Epochs(raw_subset, word_events, event_id=None, tmin=-.2, tmax=.6, preload=True, baseline=None,
                        event_repeated='drop')
