...
for hemi in hemispheres:
    for analysis_type, title in files_and_titles:
        ...
        # Generate colors based on weights using the seismic colormap
        ...
        for pos, col in zip(electrode_positions, colors):
            x, y, z = pos
            brain.add_foci([[x, y, z]], coords_as_verts=False, hemi=hemi, color=col, scale_factor=0.5, alpha=1.0, name=analysis_type)

        # Save the visualization
        save_path = os.path.join('/Users/derekrosenzweig/Documents/GitHub/CCA-Decoding/figures/pysurfer', f'{analysis_type}_{num_elecs}_{hemi}.png')
