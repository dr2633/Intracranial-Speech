...
for freq in freqs:
    ...
    # Assuming 'anatomical_region' column is part of the combined_df or you have a separate mapping
    # Here we use a mock anatomical region information
    anatomical_info = 'Anat_Label'
    combined_df[anatomical_info] = pd.Series(...)  # Provide actual anatomical region data
