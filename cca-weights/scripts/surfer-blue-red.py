...
for hemi in hemispheres:
    for analysis_type, title in files_and_titles:
        ...
        electrode_data = pd.read_csv(electrode_file, delim_whitespace=True, header=None, names=['x', 'y', 'z', 'LvsR', 'weight', 'WMvsGM'])
        ...
        save_path = os.path.join(base_path, 'figures/surfer-blue-red', f'{analysis_type}_{num_elecs}_{hemi}.png')
