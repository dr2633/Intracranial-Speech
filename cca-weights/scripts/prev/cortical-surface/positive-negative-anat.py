...
lh_dir = '/cca-weights/txt/features'
rh_dir = '/cca-weights/txt/features'
...
for hemi in hemispheres:
    for analysis_type, title in files_and_titles:
        ...
        save_path = os.path.join(f'{base_path}/figures/pysurfer', f'{analysis_type}_{num_elecs}_{hemi}.png')
