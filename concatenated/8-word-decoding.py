...
features_to_decode = ('VERB', 'NOUN','DET')
...
for stim in stimuli:
        ...
        for run in runs:
            ...
            phoneme_path = os.path.join(base_path, 'annotations', 'words', 'tsv', f'{stim}-phonemes.tsv')
            ...
            for feat in features:
                ...
                plt.title(f"Decoding Accuracy for {feat}")
                ...
                save_path = f'{save_directory}/{feat}_logistic.jpg'
